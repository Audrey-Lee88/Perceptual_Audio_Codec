...
-----------------------------------------------------------------------
© 2009-2021 Marina Bosi & Richard E. Goldberg -- All rights reserved
-----------------------------------------------------------------------
...
Jan 2021 - Updates pcmfile.py to read data blocks with arbitrary information 
between data and the header/format block.  (SQAM  disk currently adds text info 
between them which, if it doesn’t use the word “data” should no longer cause problems.)
"""
